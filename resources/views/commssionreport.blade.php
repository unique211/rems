...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    var getallsite="{{url('getagentcommssionsite')}}";
    var getsiteploat="{{url('getagentsiteploat')}}";
    var getagentrep="{{url('getagentcomreport')}}";
    var getdata="{{url('getagentrepcomssdata')}}";
    var siteploats="{{url('getsiteploats')}}";
    var getploatsagent="{{url('getploatsagentinfo')}}";


</script>
<script type='text/javascript' src="{{ URL::asset('/resources/js/myjs/agentcommssionrep.js') }}"></script>
