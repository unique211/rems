                    ...
                    <div class="row tablehideshow card">
                        ...
                        <div class="col-md-12" style="width:100%">
                            <div class="table-responsive" id="show_master">
                                <table id="categorytb"
                                class="table table-hover table-striped  table-bordered dataTable dtr-inline" role="grid" aria-describedby="example_info"
                                    style="width:100%">
                                    <thead>
                                        <tr>
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
    ...
    var getsiteploat="{{url('getallsites')}}"
    var getdata="{{url('getsoldloatsdata')}}"

</script>
<script type='text/javascript' src="{{ URL::asset('/resources/js/myjs/soldplotrep.js') }}"></script>
