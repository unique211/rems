...
<head>
    ...
    <title>Real Asset Management </title>
    <meta name="viewport"
                                                ...
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-sunny-morning"
                                                        ...
                                                        <div class="slide-img-bg"
                                                            style="background-image: url('resources/sass/images/avatars/citydark.jpg');">
                                                        </div>
                                                        <div class="slider-content">
                                                            <h3>Complex, but lightweight</h3>
                                                            <p>We've included a lot of components that cover almost all
                                                                use cases for any type of application.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-plum-plate"
                                                        tabindex="-1">
                                                        <div class="slide-img-bg"
                                                            style="background-image: url('resources/sass/images/avatars/city.jpg');">
                                                        </div>
                                                        <div class="slider-content">
                                                            <h3>Perfect Balance</h3>
                                                            <p>ArchitectUI is like a dream. Some think it's too good to
                            ...
                            <div>
                                <form class="" id="login_form" name="login_form">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="exampleEmail"
                                                    class="">User Name</label><input id="username" name="username"
                                                    id="exampleEmail" placeholder="User Name here.." type="text"
                                    ...
                                    <div class="position-relative form-check">
                                        ...
                                        <label for="exampleCheck" class="form-check-label"></label></div>
                                    <div class="divider row"></div>
